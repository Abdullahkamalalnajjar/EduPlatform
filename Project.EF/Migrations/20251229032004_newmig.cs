        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentPhoneNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseSubscriptions_Students_StudentId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "c7e2f9a4-6b3d-4a1f-8c9e-2b7d6a5f4e33", "b2d8f6a3-4c7e-5f9a-8b1c-2d3e4f5a6b22", false, false, "Parent", "PARENT" },
                    { "d3a4b7f2-1f6c-4b2a-9a2b-3d9b8a1c2e11", "a1f7c9d2-3b5e-4f8a-9c2d-7e6b5a4c3f21", false, false, "Teacher", "TEACHER" },
                    { "e5b1c3a7-9d2f-4c6b-8a7e-1f2d3c4b5a44", "c3e9a7b4-5d8f-6a2b-9c3e-4f1a2b3c7d33", false, false, "Student", "STUDENT" },
                    { "f4c6a2d8-8b1e-4f3c-9a5d-2b3c4e6f7a55", "d4f1b8c5-6e9a-7b3c-8d4e-5a2b3c4d8e44", false, false, "Assistant", "ASSISTANT" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "IsDisable", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "6dc6528a-b280-4770-9eae-82671ee81ef7", 0, "99d2bbc6-bc54-4248-a172-a77de3ae4430", "admin@eduplatform.com", true, "Edu", false, "Platform", false, null, "ADMIN@EDUPLATFORM.COM", "ADMIN@EDUPLATFORM.COM", "AQAAAAIAAYagAAAAEBDQtLhx3P3q2s2VUfY4MQ4YW8CK+Utz+LJ36vMVUX00IxkwbNR5aVSWIjAIRU+Dgg==", null, false, "55BF92C9EF0249CDA210D85D1A851BC9", false, "admin@eduplatform.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "permissions", "roles:read", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    { 2, "permissions", "roles:add", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    { 3, "permissions", "roles:update", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    { 4, "permissions", "claims:read", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    { 5, "permissions", "claims:add", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    { 6, "permissions", "claims:update", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    { 7, "permissions", "claims:delete", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    ...
                    { 11, "permissions", "users:delete", "92b75286-d8f8-4061-9995-e6e23ccdee94" }
                });
